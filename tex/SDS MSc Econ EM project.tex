...
For the model update, data was taken directly from the most recent update of the WDI database, \cite{theworldbankWorldDevelopmentIndicators2019}, and two countries were added for comparison: India (constant industrialisation level) and the United Kingdom (de-industrialising). 
...
\subsection{Graphs}\label{sec:graph_appendix}
