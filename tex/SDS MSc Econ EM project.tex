...
For reference, the complete program output for the model can be found in \cref{fig:orig_model_output} (discarding missing data) and \cref{fig:orig_model_fiml_output} (imputing missing data) in \cref{sec:program_output}
...
\end{subfigure}
\caption{Original path model output, missing data discarded}
...
\begin{figure}[htbp]
\begin{subfigure}{\textwidth}
\input{./plots/model.path.fit.fiml.summary.tex}
\caption{Model summary}
\end{subfigure}
\caption{Original path model output, missing data imputed}
\label{fig:orig_model_fiml_output}
\end{figure}

\begin{figure}[htbp]\ContinuedFloat
\begin{subfigure}{\textwidth}
\input{./plots/model.path.fit.fiml.estimates.tex}
\caption{Parameter estimates}
\end{subfigure}
\caption{Original path model output, missing data imputed}
\end{figure}
