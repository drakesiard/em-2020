...
An analysis not described in this paper (but available in as described in \cref{sec:data_and_code} finds significant relationships between EI and FX, and P\_GDP and FX; however, even controlling for FX, there remains a relationship between EI and P\_GDP that disappears when using the PPP-adjusted EIb and P\_GDPb.
}
\end{itemize}
...
\begin{adjustbox}{max width=\textwidth}
\url{https://htmlpreview.github.io/?https://github.com/drakesiard/em-2020/blob/master/analysis/8_FX_impact.html}
\end{adjustbox}
