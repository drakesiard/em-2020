...
The only coefficient of any significance is $P_{P_GDPb,TO}$, the effect of trade openness on economic development, which is positive, as expected by conventional economic theory.
...
Running the regression on India, a comparable country with a longer alternative energy intensity timeseries (EIc) and a stronger correlation structure (\cref{fig:logdiff_correlations_india})
...
\midrule
     ...
     (3) &       EIb &       ISG &      $P_{EIb,ISG}$ &        0.011 &        0.208 &   0.960 &   0.116 \\
...
Causal variable & Coeff. & s.e. & p-value & Coeff. & s.e. & p-value & Coeff. & s.e. & p-value \\
\midrule
            ISG &     0.011 &   0.208 &      0.960 &     0.019 &   0.070 &      0.791 &     0.029 &   0.231 &      0.900 \\
             TO &     0.086 &   0.185 &      0.644 &    -0.116 &   0.082 &      0.161 &    -0.030 &   0.175 &      0.864 \\
